...
void motor_balance_compensation()
{
	while (r)
	{
		...
		//标准四轴平衡补偿
		speed[0] = (int) e->v + (int) ((e->v / (MAX_SPEED_RUN_MAX / 2.0)) * (0 - e->x_devi + e->z_devi - e->xv_devi));
		speed[1] = (int) e->v + (int) ((e->v / (MAX_SPEED_RUN_MAX / 2.0)) * (0 - e->y_devi - e->z_devi + e->yv_devi));
		speed[2] = (int) e->v + (int) ((e->v / (MAX_SPEED_RUN_MAX / 2.0)) * (0 + e->x_devi + e->z_devi + e->xv_devi));
		speed[3] = (int) e->v + (int) ((e->v / (MAX_SPEED_RUN_MAX / 2.0)) * (0 + e->y_devi - e->z_devi - e->yv_devi));
