...
__attribute__((section(".isr_vectors"))) void (* const g_pfnVectors[])(void) =
{
...
void Reset_Handler(void)
{
	...
	main(0, 0); /* start execution of the program */
	while (1)
	{
	}
}
